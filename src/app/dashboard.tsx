    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-[#181c2b] via-[#23243a] to-[#2e254d] text-white relative overflow-x-hidden">
            ...
            <a
                ...
                className="fixed top-6 right-8 z-50 p-3 rounded-full bg-gradient-to-tr from-fuchsia-600 via-blue-600 to-violet-600 shadow-lg hover:scale-110 transition-transform border-2 border-blue-300 hover:border-fuchsia-400"
            >
                <IconRocket size={32} className="text-white animate-bounce" />
            </a>
